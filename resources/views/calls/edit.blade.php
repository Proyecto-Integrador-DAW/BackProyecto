                    ...
                    <form action="{{ route('calls.update', $call->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <select name="teleoperator_id" id="teleoperator_id" class="w-full rounded-md shadow-sm" required>
                                    @foreach ($teleoperators as $teleoperator)
                                        <option value="{{ $teleoperator->id }}" {{ $call->teleoperator_id == $teleoperator->id ? 'selected' : '' }}>{{ $teleoperator->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <select name="patient_id" id="patient_id" class="w-full rounded-md shadow-sm" required>
                                    @foreach ($patients as $patient)
                                        <option value="{{ $patient->id }}" {{ $call->patient_id == $patient->id ? 'selected' : '' }}>{{ $patient->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="call_type" id="call_type" class="w-full rounded-md shadow-sm" required>
                                <option value="Entrante" {{ $call->call_type == 'Entrante' ? 'selected' : '' }}>Entrante</option>
                                <option value="Saliente" {{ $call->call_type == 'Saliente' ? 'selected' : '' }}>Saliente</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="type" id="type" class="w-full rounded-md shadow-sm" required>
                                @foreach ([
                                    ...
                                    <option value="{{ $category }}" {{ $call->type == $category ? 'selected' : '' }}>{{ $category }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" name="call_time" id="call_time" value="{{ $call->call_time }}" class="w-full rounded-md shadow-sm" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="title" id="title" class="w-full rounded-md shadow-sm">{{ $call->title }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" class="w-full rounded-md shadow-sm">{{ $call->description }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="alert_id" id="alert_id" class="w-full rounded-md shadow-sm">
                                ...
                                @foreach ($alerts as $alert)
                                    <option value="{{ $alert->id }}" {{ $call->alert_id == $alert->id ? 'selected' : '' }}>{{ $alert->description }}</option>
                                @endforeach
                            </select>
