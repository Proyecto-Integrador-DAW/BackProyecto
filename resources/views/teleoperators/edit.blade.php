...
@section('title', 'Editar Teleoperador')

@section('content')
    <h1 class="text-3xl font-bold text-blue-800 mb-6">Editar Teleoperador</h1>
    <form action="{{ route('teleoperators.update', $teleoperator->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
        @csrf
        @method('PUT')

        <div class="mb-4">
            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nombre:</label>
            <input type="text" name="name" id="name" value="{{ old('name', $teleoperator->name) }}" required
        ...
        <div class="mb-4">
            ...
            <input type="email" name="email" id="email" value="{{ old('email', $teleoperator->email) }}" required
                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 
        ...
        <div class="mb-4">
            ...
            <input type="text" name="prefix" id="prefix" value="{{ old('prefix', $teleoperator->prefix) }}" required
                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 
        ...
        <div class="mb-4">
            ...
            <input type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $teleoperator->phone_number) }}" required
                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 
        ...
        <div class="mb-4">
            ...
            <select name="zone_id" id="zone_id" required
                ...
                @foreach ($zones as $zone)
                    <option value="{{ $zone->id }}" {{ $zone->id == $teleoperator->zone_id ? 'selected' : '' }}>
                        {{ $zone->city }} - {{ $zone->zone }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-4">
            ...
            <input type="date" name="hiring_date" id="hiring_date" value="{{ old('hiring_date', $teleoperator->hiring_date) }}" required
                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 
        ...
        <div class="mb-4">
            ...
            <input type="text" name="code" id="code" value="{{ old('code', $teleoperator->code) }}" required
                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 
        ...
        <div class="mb-4">
            ...
            <input type="date" name="firing_date" id="firing_date" value="{{ old('firing_date', $teleoperator->firing_date) }}"
                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 
