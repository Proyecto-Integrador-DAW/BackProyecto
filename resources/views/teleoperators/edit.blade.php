        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('teleoperators.update', $teleoperator->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                name="name"
                                id="name"
                                value="{{ old('name', $teleoperator->name) }}"
                        ...
                        <div class="mb-4 flex flex-wrap md:flex-nowrap gap-1 md:gap-2">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="email"
                                    name="email"
                                    id="email"
                                    value="{{ old('email', $teleoperator->email) }}"
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="password"
                                    name="password"
                                    id="password"
                                    value="{{ old('password', $teleoperator->password) }}"
                        ...
                        <div class="mb-4 flex flex-wrap md:flex-nowrap gap-1 md:gap-2">
                            ...
                            <div class="w-full md:w-1/3">
                                ...
                                <input type="text"
                                    name="prefix"
                                    id="prefix"
                                    value="{{ old('prefix', $teleoperator->prefix) }}"
                            ...
                            <div class="w-full md:w-2/3">
                                ...
                                <input type="text"
                                    name="phone_number"
                                    id="phone_number"
                                    value="{{ old('phone_number', $teleoperator->phone_number) }}"
                        ...
                        <div class="mb-4 flex flex-wrap md:flex-nowrap gap-1 md:gap-2">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="number"
                                    name="code"
                                    id="code"
                                    value="{{ old('code', $teleoperator->code) }}"
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                >
                                    @foreach ($zones as $zone)
                                        <option value="{{ $zone->id }}" {{ old('zone_id', $teleoperator->zone_id) == $zone->id ? 'selected' : '' }}>{{ $zone->city }} - {{ $zone->zone }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-4 flex flex-wrap md:flex-nowrap gap-1 md:gap-2">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="date"
                                    name="hiring_date"
                                    id="hiring_date"
                                    value="{{ old('hiring_date', $teleoperator->hiring_date) }}"
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <input type="date"
                                    name="firing_date"
                                    id="firing_date"
                                    value="{{ old('firing_date', $teleoperator->firing_date) }}"
                            ...
                            <div class="flex flex-wrap gap-2">
                                @foreach ($languages as $language)
                                    <label class="flex items-center cursor-pointer bg-gray-200 dark:bg-gray-700 px-4 py-2 rounded-lg shadow-sm transition-all hover:bg-gray-300 dark:hover:bg-gray-600">
                                        <input type="checkbox" name="languages[]" value="{{ $language->id }}" class="hidden peer" @if($teleoperator->languages->contains($language->id)) checked @endif>
