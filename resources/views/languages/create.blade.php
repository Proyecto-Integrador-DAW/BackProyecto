...
@section('title', 'Añadir Idioma')

@section('content')
    <h1 class="text-3xl font-bold text-blue-800 mb-6">Añadir Idioma</h1>
    <form action="{{ route('languages.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
        @csrf
